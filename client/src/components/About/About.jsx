    ...
    <div id="about" className={style.body}>
      ...
      <div className={style.textContainer}>
        ...
        <p className={style.text}>
          <FaCheckSquare color="orange" size={18} /> I'm a Full Stack Developer
        ...
        <p className={style.text}>
          ...
          JavaScript and Java languages, HTML, CSS and also in technologies like
          Node.js, Express, Sequelize, PostgreSQL, React.js, Redux. VCS tool:
          Git. Agile: Scrum.
        </p>
      </div>
    </div>
