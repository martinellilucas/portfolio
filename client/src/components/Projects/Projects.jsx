        ...
        <div className={style.contentGrid}>
          <div id="projects" className={style.timeline}>
            <div data-aos="fade-left" className={style.childImpar}>
              <h1>Henry's Gym</h1>
              <p>
                Web application for a gym with third-party authentication,
                payment gateway, admin dashboard, subscriptions, user bans and
                reviews
              </p>
            ...
            <div data-aos="fade-left" className={style.childImpar}>
              <h1>Rick & Morty</h1>
              <p>
                Web application of the animated series rick and morty with
          ...
          <div id="projects" className={style.timeline}>
            <div data-aos="fade-left" className={style.childImpar}>
              ...
              <p>
                ...
                pasarela de pagos, panel de administración, suscripciones,
                baneos de usuarios y comentarios
              </p>
              <Link className={style.link} to="https://henry-gym.onrender.com/">
                Visit
              </Link>
